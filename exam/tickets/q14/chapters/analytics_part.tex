...
1  & cmdline  & файл                                                                                             & \multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Указывает на директорию процесса\end{tabular}}                                                                                                                                                                                \\ \cline{1-3}
2  & cwd      & \begin{tabular}[c]{@{}l@{}}символическая\\ ссылка\end{tabular}                                   &                                                                                                                                                                                                                                                                            \\ \hline
